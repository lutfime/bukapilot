from openpilot.selfdrive.mapd_kommu.lib.geo import DIRECTION, R, vectors, bearing_to_points, distance_to_points
from openpilot.selfdrive.mapd_kommu.lib.osm import create_way
from openpilot.common.constants import CV
from openpilot.selfdrive.mapd_kommu.config import LANE_WIDTH
...
with open(BASEDIR + "/selfdrive/mapd_kommu/lib/default_speeds.json", "rb") as f:
