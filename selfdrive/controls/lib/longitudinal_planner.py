...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    # CSC is ON BY DEFAULT (CSCEnabled defaults true) whenever OP controls longitudinal.
    # Model-based, safe, slowdown-only, the primary corner-slowdown. Deliberately NOT gated by
