...
struct SettingsSheet: View {
  ...
  // Local mirror of toggle states so the UI feels instant; the device echoes
  // the real value back in the next settings frame (~3 Hz) and we sync.
